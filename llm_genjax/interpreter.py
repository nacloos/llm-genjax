# Code adapted from https://github.com/WecoAI/aideml/blob/main/aide/interpreter.py
"""
...
try:
    # multiprocessing fork raises warnings with jax multithreading
...
if __name__ == "__main__":
    working_dir = Path(__file__).parent / "results" / "interpreter"
    working_dir.mkdir(parents=True, exist_ok=True)
    interpreter = Interpreter(working_dir=working_dir)
    res = interpreter.run("prin('Hello, world!')")
    print(res)
